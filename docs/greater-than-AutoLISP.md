...
Returns
*T* if each argument is numerically greater than the argument to its right; otherwise returns
*nil*
...
T, if each argument is numerically greater than the argument to its right; otherwise
