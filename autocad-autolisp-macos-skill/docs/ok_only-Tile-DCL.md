...
The
ok\_only tile is a solitary OK button, such as the kind that alert boxes use.
...
![](../images/GUID-8D8D4DD5-D368-4535-ABFC-5223EA082CDB-low.png)

The key of the OK button is
"accept".

The
ok\_only tile is defined in the
*base.dcl* file.
