...
| 14 | Snap spacing  DXF: *X* value; APP: 2D point |
...
NOTE: The ZOOM XP factor is calculated with the following formula: group\_41 / group\_45 (or pspace\_height / mspace\_height).
