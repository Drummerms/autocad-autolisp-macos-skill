...
*Tool Set*:
Drafting tab ![](../images/ac.menuaro.gif) Parametric panel ![](../images/ac.menuaro.gif) Dimensional Constraint drop-down ![](../images/ac.menuaro.gif) Horizontal.
![](../images/GUID-506AB966-57B9-439B-941B-062A8D20B594-low.png)

*Menu*:
Tools ![](../images/ac.menuaro.gif) Parametric ![](../images/ac.menuaro.gif) Dimensional Constraints ![](../images/ac.menuaro.gif) Horizontal.

## Summary

This command is equivalent to the Horizontal option in
...
| Line  Polyline segment  Arc  Two constraint points on objects | * When a line or an arc is selected, the horizontal distance between the endpoints of the object is constrained. |
...
Specify first
[constraint point](DCHORIZONTAL-Command.md) or [[Object](DCHORIZONTAL-Command.md)] <Object>:
