...
Transfer settings from one machine to another. Settings can include user profile, toolbar and toolset customizations, command
aliases, plot settings, templates, and the My Properties settings for the Property palette.
...
* [About Exporting and Importing Custom Settings](About-Exporting-and-Importing-Custom-Settings.md)
