...
The following group codes are used by SPATIAL\_INDEX objects.

| SPATIAL\_INDEX group codes | |
| Group code | Description |
| 0 | Object name (SPATIAL\_INDEX) |
| 5 | Handle |
...
The SPATIAL\_INDEX is always written out empty to a DXF file. This object can be ignored.
