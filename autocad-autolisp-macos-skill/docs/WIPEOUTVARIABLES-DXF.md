...
| 330 | Soft-pointer ID/handle to owner dictionary. For a WIPEOUTVARIABLES object, this is always the ACAD\_IMAGE\_VARS entry of the named object dictionary |
