...
*Menu*:
Modify
![](../images/ac.menuaro.gif) Surface Editing
![](../images/ac.menuaro.gif) Convert to Mesh.
...
Use this method to convert 3D faces (3DFACE) and legacy polygonal and polyface meshes (from
AutoCAD 2009 and earlier). You can also convert 2D objects such as regions and closed polylines.
