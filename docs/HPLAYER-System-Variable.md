...
Values other than the “.” (use current) value override the current layer (CELAYER). You can specify a currently nonexistent
layer as the default layer for new hatches and fills.
