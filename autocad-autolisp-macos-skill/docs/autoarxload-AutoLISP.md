...
:   *Type:* String
    ...
    ObjectARX file to be loaded when one of the commands defined by the
...
*cmdlist*, AutoCAD loads the ObjectARX application specified in
...
C:APP1,
C:APP2, and
C:APP3 functions to load the
*bonusapp.arx* or
*bonusapp.bundle* file:
