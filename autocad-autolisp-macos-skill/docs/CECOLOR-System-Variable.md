...
* Color Books: Text from standard PANTONE or custom color books, the DIC color guide, or RAL color sets, for example "DIC COLOR
  GUIDE(R)$DIC 43"

#### Related Concepts

* [About Color Books](About-Color-Books.md)
* [About Setting the Color of Objects](About-Setting-the-Color-of-Objects.md)
