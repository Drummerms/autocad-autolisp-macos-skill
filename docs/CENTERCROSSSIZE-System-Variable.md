# CENTERCROSSSIZE (System Variable)
...
The CENTERCROSSSIZE system variable applies only to center marks created using the CENTERMARK command. A center mark has a
...
| "ByLineType" | The size of the center mark is derived from linetype assigned to it.  NOTE:When the linetype of the center mark has only dash and gap, the size of the last dash and gap of the pattern is used as the center mark size and gap. If the linetype pattern of the center mark has other kinds of elements, the default setting is used. |

![](../images/GUID-EE686AA8-64F1-4A98-B439-5E9737525746-low.png)

#### Related References

* [CENTERCROSSGAP (System Variable)](CENTERCROSSGAP-System-Variable.md)
