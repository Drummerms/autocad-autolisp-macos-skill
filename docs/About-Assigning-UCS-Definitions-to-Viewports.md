...
To facilitate editing objects in different views, you can define a different user coordinate system (UCS) for each view.
...
The example is illustrated in the following illustrations. The first figure shows the isometric viewport reflecting the UCS
of the upper-left, or top, viewport, which is current.

![](../images/GUID-5D3139B4-81E6-4091-9439-79342ED4633E-low.png)

The next figure shows the change that occurs when the lower-left, or front, viewport is made current. The UCS in the isometric
